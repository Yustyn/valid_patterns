...
product_name_pattern = r'^([a-z])+([\ ])*([a-z])*([\ ])*([-|_|0-9])*'
description_pattern = r'^(([a-zA-Z0-9])*([\ ])*([a-zA-Z0-9]))*([\ ])*([-|_|0-9])*'
img_pattern = r''
...
PRODUCT_SUBCATEGORY = {"id": [int, number_pattern], "subcategory_name": [
    str, product_name_pattern], "category_name": [int, number_pattern]}

PRODUCT_CATEGORY = {"id": [int, number_pattern],
                    "category_name": [str, product_name_pattern]}

PRODUCT = {"id": [int, number_pattern], "code": [int, number_pattern], "product_name": [str, product_name_pattern],
           "unit_price": [float, number_pattern], "count": [int, number_pattern], "description": [str, description_pattern],
           "img": [str, img_pattern], "email": [str, email_pattern], "role": [str, role_pattern], "discount": [int, number_pattern]}

ORDERS = {"id": [int, number_pattern], "date_of_order": [str, date_pattern], "customer_id": [int, number_pattern],
          "product_id": [int, number_pattern], "price": [int, number_pattern], "count": [int, number_pattern],
